...
window.renderCouncilCards = renderCouncilCards;
window.renderCouncilSlotsTable = renderCouncilSlotsTable;
window.renderCouncilStudentsTab = renderCouncilStudentsTab;
window.getRoundAllStudents = getRoundAllStudents;
window.findStudentInRound = findStudentInRound;
window.renderCouncilMembersFormSlots = renderCouncilMembersFormSlots;
window.persistActivityCouncilChanges = persistActivityCouncilChanges;
window.renderEffectiveCouncilMembershipNotice = renderEffectiveCouncilMembershipNotice;
window.renderStudentCouncilTimelineInfo = renderStudentCouncilTimelineInfo;
window.checkCouncilAuthorization = checkCouncilAuthorization;
window.getRequiredScorers = getRequiredScorers;
window.getGuestScorers = getGuestScorers;
window.setupCouncilRealtimeSync = setupCouncilRealtimeSync;
window.loadCouncilScores = loadCouncilScores;
window.renderCouncilWorkspaceFull = renderCouncilWorkspaceFull;
window.renderCouncilWorkspacePartialSync = renderCouncilWorkspacePartialSync;
window.renderCouncilStudentList = renderCouncilStudentList;
window.renderCouncilSelectedStudentDetails = renderCouncilSelectedStudentDetails;
window.formatStudentSupervisorsForDisplay = formatStudentSupervisorsForDisplay;
window.renderPresentingBanner = renderPresentingBanner;
window.renderSecretaryControls = renderSecretaryControls;
window.renderScoringSection = renderScoringSection;
window.renderScorersProgress = renderScorersProgress;
window.renderAdminMonitor = renderAdminMonitor;
...
window.renderSupervisorScoreCell = renderSupervisorScoreCell;
window.renderThesisHdScoreCell = renderThesisHdScoreCell;
window.persistScoreItem = persistScoreItem;
window.renderAdminPreliminaryConfig = renderAdminPreliminaryConfig;
window.renderAdminSupervisorScoreConfig = renderAdminSupervisorScoreConfig;
window.renderAdminReviewerAssignmentTable = renderAdminReviewerAssignmentTable;
window.resolveScoreNumericValue = resolveScoreNumericValue;
window.getOfficialDefenseScore = getOfficialDefenseScore;
window.getStudentDefenseScore = getStudentDefenseScore;
window.getFinalScore = getFinalScore;
window.computeRoundRanking = computeRoundRanking;
window.sanitizeExcelCell = sanitizeExcelCell;
window.sanitizeSheetName = sanitizeSheetName;
window.fmtToday = fmtToday;
window.filterStudentList = filterStudentList;
window.updateFilterCountBadges = updateFilterCountBadges;
